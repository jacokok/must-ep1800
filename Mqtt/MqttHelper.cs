...
public static class MqttHelper
{
    public static readonly List<RegisterTopic> Topics = new() {
        ...
        new RegisterTopic { Name = "ChargerPower", UnitOfMeasurement = "W", Icon = "car-turbopower" },
        ...
        new RegisterTopic { Name = "AccumulatedDay", UnitOfMeasurement = "day", Icon = "calendar-day" },
