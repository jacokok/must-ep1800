...
public static class MqttHelper
{
    public static readonly List<RegisterTopic> Topics = new() {
        ...
        new RegisterTopic { Name = "AcRadiatorTemp", UnitOfMeasurement = "℃", Icon = "thermometer", DeviceClass="temperature", StateClass="measurement" },
        new RegisterTopic { Name = "TransformerTemp", UnitOfMeasurement = "℃", Icon = "thermometer", DeviceClass="temperature", StateClass="measurement" },
        new RegisterTopic { Name = "DcRadiatorTemp", UnitOfMeasurement = "℃", Icon = "thermometer", DeviceClass="temperature", StateClass="measurement" },
        ...
        new RegisterTopic { Name = "RadiatorTemp", UnitOfMeasurement = "℃", Icon = "thermometer", DeviceClass="temperature", StateClass="measurement" },
        new RegisterTopic { Name = "ExternalTemp", UnitOfMeasurement = "℃", Icon = "thermometer", DeviceClass="temperature", StateClass="measurement" },
        ...
        new RegisterTopic { Name = "AccumulatedChargerPower", UnitOfMeasurement = "kWh", Icon = "chart-bell-curve-cumulative", DeviceClass = "energy" },
        new RegisterTopic { Name = "AccumulatedDischargerPower", UnitOfMeasurement = "kWh", Icon = "chart-bell-curve-cumulative", DeviceClass = "energy" },
        new RegisterTopic { Name = "AccumulatedBuyPower", UnitOfMeasurement = "kWh", Icon = "chart-bell-curve-cumulative", DeviceClass = "energy" },
        ...
        new RegisterTopic { Name = "AccumulatedSelfusePower", UnitOfMeasurement = "kWh", Icon = "chart-bell-curve-cumulative", DeviceClass = "energy" },
